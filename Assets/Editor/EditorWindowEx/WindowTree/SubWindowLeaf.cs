...
internal class SubWindowLeaf : SubWindowNode
{
    ...
    public override void DrawGUI(Rect rect, System.Action repaintAction)
    {
        ...
        {
            GUI.Label(new Rect(m_SelectSubWindow * 110, 0, rect.width - m_SelectSubWindow * 110, 18), m_SubWindows[m_SelectSubWindow].Title, GUIStyleCache.GetStyle("dragtabdropwindow"));
        }
